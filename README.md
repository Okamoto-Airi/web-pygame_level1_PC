# Pygameで作るシューティングゲーム レベル1

Pygameを使って制作したシューティングゲームです。

プレイヤーは魔女を操作して敵のUFOの爆弾を避けながらビームで攻撃します。
...
[シューティングゲーム レベル1](https://okamoto-airi.github.io/web-pygame_level1_PC/)
...
- `sprites.py` ・・・ スプライト（魔女・UFO・ビーム・爆弾・爆発など）のクラス定義
...
![サンプルGIF](picture/level1_sample.gif)
